...
//        animalsArray = [testAnimal]
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = "Cell \(indexPath.row). \(animal.name)"
        return cell
    }
...
//                destinationVC.nameLabel.text = selectedAnimal.name
//                destinationVC.lastSeenLabel.text = selectedAnimal.dateLastSeen
//                destinationVC.locationLabel.text = selectedAnimal.location
//                destinationVC.imageView.image = selectedAnimal.imageURL
//                destinationVC.imageView.image = UIImage(
        }
    }
